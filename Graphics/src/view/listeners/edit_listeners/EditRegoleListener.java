 ...
 */
public class EditRegoleListener implements ActionListener {
    private Interpretatore inter;
    private Rappresentatore rapp;
    private Verificatore ver;
    private PannelloNord pannelloNord;

    public EditRegoleListener(Interpretatore inter, Rappresentatore rapp, Verificatore ver, PannelloNord pannelloNord) {
        this.inter = inter;
        this.rapp = rapp;
        this.ver = ver;
