...
public class EditCreazioneRegole implements ActionListener {
    ...
    public EditCreazioneRegole(Interpretatore inter, Rappresentatore rapp, Verificatore ver, PannelloNord pannelloNord){
        this.inter = inter;
        this.ver = ver;
