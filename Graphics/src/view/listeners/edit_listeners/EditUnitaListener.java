 ...
 */
public class EditUnitaListener implements ActionListener {

    private Interpretatore inter;
    private Rappresentatore rapp;
    private PannelloNord pannelloNord;

    public EditUnitaListener(Interpretatore inter, Rappresentatore rapp, PannelloNord pannelloNord) {
        this.inter = inter;
        this.rapp = rapp;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(actionCommand.equalsIgnoreCase("Rimuovi unità immobiliare corrente")){
            ...
            int ok = JOptionPane.showOptionDialog(null, campoNomeStanza, "Inserimento Nuova Stanza", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
            if(ok == 0){
