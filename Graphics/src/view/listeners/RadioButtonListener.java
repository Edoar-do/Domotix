...
import view.listeners.edit_listeners.*;
import javax.swing.*;
...
public class RadioButtonListener implements ActionListener {
    ...
    public RadioButtonListener(Rappresentatore rapp, Verificatore ver, Interpretatore inter, PannelloNord pannelloNord) {
        this.rapp = rapp;
        this.ver = ver;
        this.inter = inter;
    ...
    private void attaccaListenerManutentore(Interpretatore inter, Rappresentatore rapp){
        ...
        edit_unitaListener = new EditUnitaListener(inter, rapp, pannelloNord);
        ...
        edit_sensStanzaListener = new EditSensoreStanzaListener(inter, rapp, pannelloNord);
        m_addSensStanza.addActionListener(edit_sensStanzaListener);
        m_rimuoviSensStanza.addActionListener(edit_sensStanzaListener);
        edit_attStanzaListener = new EditAttuatoreStanzaListener(inter, rapp, pannelloNord);
        m_addAttStanza.addActionListener(edit_attStanzaListener);
        m_rimuoviAttStanza.addActionListener(edit_attStanzaListener);
        edit_artefattoStanzaListener = new EditArtefattoStanzaListener(inter, rapp, pannelloNord);
        ...
        edit_sensArtefattoListener = new EditSensoreArtefattoListener(inter, rapp, pannelloNord);
        ...
        edit_attArtefattoListener = new EditAttuatoreArtefattoListener(inter, rapp, pannelloNord);
        ...
        edit_collegaDispositiviStanzaListener = new EditCollegaDispStanzaListener(inter, rapp, pannelloNord);
        ...
        edit_collegaDispositiviArtefattoListener = new EditCollegaDispArtefattoListener(inter, rapp, pannelloNord);
    ...
    private void attaccaListenerFruitore(Interpretatore inter, Rappresentatore rapp, Verificatore ver) {
        ...
        edit_setModeAttListener = new EditSetModalitaAttListener(inter, rapp, pannelloNord);
        ...
        edit_regoleListener = new EditRegoleListener(inter, rapp, ver, pannelloNord);
        ...
        edit_creazioneRegoleListener = new EditCreazioneRegole(inter, rapp, ver, pannelloNord);
