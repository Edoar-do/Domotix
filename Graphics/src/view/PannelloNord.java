...
public class PannelloNord extends JPanel {
    ...
    private JMenuItem file_apriUnita, file_categorieSensori, file_categorieAttuatori, file_unita,
            ...
            importa_unita, importa_categorieSensori, importa_categorieAttuatori, help_glossarioErrori;
    ...
    private void popolaHelp(){
        help_glossarioErrori = new JMenuItem("Glossario Errori");
        help.add(help_glossarioErrori);
    }
    ...
    private void attaccoListeners(Interpretatore inter, Rappresentatore rapp, Importatore imp, Verificatore ver){
        ...
        nuovoUnitaListener = new NuovoUnitaListener(this, inter);
        file_unita.addActionListener(nuovoUnitaListener);
        nuovoCategoriaSensoriListener = new NuovoCategoriaSensoriListener(inter);
        file_categorieSensori.addActionListener(nuovoCategoriaSensoriListener);
        nuovoCategoriaAttuatoriListener = new NuovoCategoriaAttuatorilistener(inter);
        ...
        aperturaUnitaListener = new AperturaUnitaListener(this, rapp);
        ...
        radioButtonListener = new RadioButtonListener(rapp, ver, inter, this);
        radioManutentore.addActionListener(radioButtonListener);
        radioFruitore.addActionListener(radioButtonListener);
        //ATTACCO LISTENER GLOSSARIO ERRORI
        helpListener = new HelpListener();
        help_glossarioErrori.addActionListener(helpListener);
    }
